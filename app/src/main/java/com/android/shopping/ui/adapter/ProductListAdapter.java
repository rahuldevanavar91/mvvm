    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (item.getViewType() == VIEW_TYPE_PRODUCT_LIST) {
            ...
            if (orderListViewHolder.orderListAdapter != null) {
                orderListViewHolder.orderListAdapter.updateData(item.getOrderItem().getProductList(), holder.getAdapterPosition());
            } else {
                orderListViewHolder.orderListAdapter = new OrderListAdapter(mContext, item.getOrderItem().getProductList(), mClickListener, holder.getAdapterPosition());
...
*/
    ...
    public void update(List<ProductItem> productItems, int position) {
